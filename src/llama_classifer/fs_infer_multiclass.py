...
output_csv = "llama_predictions_multiclass_liar_zs_first_draft.csv"
...
if mode == "few-shot":
    print(shot_examples['label'].value_counts())
...
Choose one label from: TRUE, FALSE, barely-true, mostly-true, half-true, pants-fire
Label: {row['label']}
